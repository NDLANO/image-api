...
object TestData {
  ...
  val elg = ImageMetaInformation("1", List(ImageTitle("Elg i busk", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val bjorn = ImageMetaInformation("2", List(ImageTitle("Bjørn i busk", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val jerv = ImageMetaInformation("3", List(ImageTitle("Jerv på stein", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val mink = ImageMetaInformation("4", List(ImageTitle("Overrasket mink", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val rein = ImageMetaInformation("5", List(ImageTitle("Rein har fanget rødtopp", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val nonexisting = ImageMetaInformation("6", List(ImageTitle("Krokodille på krok", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),
  ...
  val nonexistingWithoutThumb = ImageMetaInformation("6", List(ImageTitle("Bison på sletten", Option("nb"))),List(ImageAltText("Elg i busk", Option("nb"))),

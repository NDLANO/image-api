...
class ConverterServiceTest extends UnitSuite with TestEnvironment {
  ...
  val DefaultImageMetaInformation = ImageMetaInformation(Some(1), List(ImageTitle("test", "nb")), List(), full.fileName, full.size, full.contentType, Copyright(License("", "", None), "", List(), None, None), List(), List(), "ndla124", updated)

...
-- READONLY
CREATE USER imageapi_read with PASSWORD 'Qwf9m7PywTJTrti';
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT ON TABLES TO imageapi_read;

GRANT CONNECT ON DATABASE ndla_image_api_test to imageapi_read;
...
-- WRITE
CREATE USER imageapi_write with PASSWORD 'cx8QnLj9qEszrep';

GRANT CONNECT ON DATABASE ndla_image_api_test to imageapi_write;

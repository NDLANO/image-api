...
case class ImageMetaInformation(
  ...
  @(ApiModelProperty @field)(description = "Searchable tags for the image.") tags:List[String]
)

@ApiModel(description = "The possible variants of the image")
case class ImageVariants(
  @(ApiModelProperty @field)(description = "The thumbsize image") small: Image,
  @(ApiModelProperty @field)(description = "The fullsize image") full: Image
)

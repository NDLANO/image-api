...
case class ImageMetaInformationSingleLanguage(@(ApiModelProperty@field)(description = "The unique id of the image") id: String,
                                              ...
                                              @(ApiModelProperty@field)() language: String,
                                              @(ApiModelProperty@field)(description = "Available title for the image") title: String,
                                              @(ApiModelProperty@field)(description = "Available alternative text for the image") alttext: String,
                                              ...
                                              @(ApiModelProperty@field)() supportedLanguages: Seq[String])

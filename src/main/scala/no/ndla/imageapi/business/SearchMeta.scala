...
trait SearchMeta {
  def matchingQuery(query: Iterable[String], minimumSize:Option[Int], language: Option[String], license: Option[String], index: Option[Int], pageSize: Option[Int]): Iterable[ImageMetaSummary]
